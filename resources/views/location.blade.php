...
<div id="titlebar" class="single submit-page">
	<div class="container">
		...
		<div class="sixteen columns">
			<h2><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Add Location & Contact Details</h2>
		</div>
...
<div class="container">
	...
	@csrf
			...
			<div class="form">
			   ...
			   <p class="note">Email is optional and can be left empty, but if entered, it will be displayed in Ad.</p>
			</div>
             ...
             <div class="form">
			    ...
			    <p class="note">Main Telephone number is optional and can be left empty, but if entered, it must contain only numbers and will be displayed in Ad.</p>
			</div>
